...
RUN mkdir -p /cordova
WORKDIR /cordova
RUN cordova create korean com.kevapps.learn_korean korean

WORKDIR /cordova/korean
...
# keytool -genkey -v -keystore learn-korean.keystore -alias learn-korean -keyalg RSA -keysize 2048 -validity 20000
